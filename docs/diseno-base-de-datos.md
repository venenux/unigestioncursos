...
-- NOTA: para usar en SQLITE remover "COMMENT" ya que no lo soporta, solo pasar el DB unidbcliente
CREATE SCHEMA IF NOT EXISTS `unidbcentral` DEFAULT CHARACTER SET utf8 
CREATE SCHEMA IF NOT EXISTS `unidbcliente` DEFAULT CHARACTER SET utf8 
-- para trabajo local/desconectado la db unidbcliente se copia entera a cada maquina, de manera opcional (para futuro)

-- -----------------------------------------------------
-- Table `unidbcentral`.`adm_juridico`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `unidbcentral`.`adm_juridico` ;

CREATE TABLE IF NOT EXISTS `unidbcentral`.`adm_juridico` (
...
-- -----------------------------------------------------
-- Table `unidbcentral`.`adm_entidad`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `unidbcentral`.`adm_entidad` ;

CREATE TABLE IF NOT EXISTS `unidbcentral`.`adm_entidad` (
...
-- -----------------------------------------------------
-- Table `unidbcentral`.`adm_entidad_usuario`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `unidbcentral`.`adm_entidad_usuario` ;

CREATE TABLE IF NOT EXISTS `unidbcentral`.`adm_entidad_usuario` (
...
-- -----------------------------------------------------
-- Table `unidbcentral`.`adm_usuario`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `unidbcentral`.`adm_usuario` ;

CREATE TABLE IF NOT EXISTS `unidbcentral`.`adm_usuario` (
...
-- -----------------------------------------------------
-- Table `unidbcentral`.`adm_perfil`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `unidbcentral`.`adm_perfil` ;

CREATE TABLE IF NOT EXISTS `unidbcentral`.`adm_perfil` (
...
-- -----------------------------------------------------
-- Table `unidbcentral`.`adm_localidad`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `unidbcentral`.`adm_localidad` ;

CREATE TABLE IF NOT EXISTS `unidbcentral`.`adm_localidad` (
...
-- -----------------------------------------------------
-- Table `unidbcentral`.`adm_entidad_localidad`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `unidbcentral`.`adm_entidad_localidad` ;

CREATE TABLE IF NOT EXISTS `unidbcentral`.`adm_entidad_localidad` (
...
-- -----------------------------------------------------
-- Table `unidbcentral`.`adm_entidad_juridico`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `unidbcentral`.`adm_entidad_juridico` ;

CREATE TABLE IF NOT EXISTS `unidbcentral`.`adm_entidad_juridico` (
...
-- -----------------------------------------------------
-- Table `unidbcentral`.`adm_log`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `unidbcentral`.`adm_log` ;

CREATE TABLE IF NOT EXISTS `unidbcentral`.`adm_log` (
...
-- -----------------------------------------------------
-- Table `unidbcentral`.`adm_patrimonio`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `unidbcentral`.`adm_patrimonio` ;

CREATE TABLE IF NOT EXISTS `unidbcentral`.`adm_patrimonio` (
...
-- -----------------------------------------------------
-- Table `unidbcentral`.`adm_patrimonio_entidad`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `unidbcentral`.`adm_patrimonio_entidad` ;

CREATE TABLE IF NOT EXISTS `unidbcentral`.`adm_patrimonio_entidad` (
...
-- -----------------------------------------------------
-- Table `unidbcentral`.`adm_poliza`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `unidbcentral`.`adm_poliza` ;

CREATE TABLE IF NOT EXISTS `unidbcentral`.`adm_poliza` (
...
-- -----------------------------------------------------
-- Table `unidbcentral`.`adm_titulo`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `unidbcentral`.`adm_titulo` ;

CREATE TABLE IF NOT EXISTS `unidbcentral`.`adm_titulo` (
...
-- -----------------------------------------------------
-- Table `unidbcentral`.`adm_documento_donde`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `unidbcentral`.`adm_documento_donde` ;

CREATE TABLE IF NOT EXISTS `unidbcentral`.`adm_documento_donde` (
...
-- -----------------------------------------------------
-- Table `unidbcentral`.`adm_patrimonio_foto`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `unidbcentral`.`adm_patrimonio_foto` ;

CREATE TABLE IF NOT EXISTS `unidbcentral`.`adm_patrimonio_foto` (
...
-- -----------------------------------------------------
-- Table `unidbcentral`.`adm_anuncios`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `unidbcentral`.`adm_anuncios` ;

CREATE TABLE IF NOT EXISTS `unidbcentral`.`adm_anuncios` (
...
-- -----------------------------------------------------
-- Table `unidbcliente`.`app_data_curso`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `unidbcliente`.`app_data_curso` ;

CREATE TABLE IF NOT EXISTS `unidbcliente`.`app_data_curso` (
...
-- -----------------------------------------------------
-- Table `unidbcliente`.`app_log`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `unidbcliente`.`app_log` ;

CREATE TABLE IF NOT EXISTS `unidbcliente`.`app_log` (
...
-- -----------------------------------------------------
-- Table `unidbcliente`.`app_registro_asistecia`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `unidbcliente`.`app_registro_asistecia` ;

CREATE TABLE IF NOT EXISTS `unidbcliente`.`app_registro_asistecia` (
...
-- -----------------------------------------------------
-- Table `unidbcliente`.`app_registro_curso`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `unidbcliente`.`app_registro_curso` ;

CREATE TABLE IF NOT EXISTS `unidbcliente`.`app_registro_curso` (
...
-- -----------------------------------------------------
-- Table `unidbcliente`.`app_anuncios`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `unidbcliente`.`app_anuncios` ;

CREATE TABLE IF NOT EXISTS `unidbcliente`.`app_anuncios` (
  `cod_anuncio` VARCHAR(40) NOT NULL COMMENT 'YYYYMMDDHHMMSS id del anuncio, aqui es unico el codigo ya que es para las entidades',
  `cod_entidad` VARCHAR(40) NULL COMMENT 'id del centro ince o lugar en donde ejecuta el app',
